...
public class SpringschedulerService_imple implements SpringschedulerService {
	...
	// === #210 Spring scheduler(스프링 스케줄러) 연습(매 1분마다 DB에 insert 하기) ===
	// !!<주의>!! 스프링스케줄러로 사용되는 메소드는 반드시 리턴타입은 void 이어야 하고, 파라미터가 없어야 한다.!!!!!!!!!!
		
	// === Spring scheduler 는 서비스단에서 작업을 하는 것이다. === //
		
	/*
	    스케줄은 3가지 종류  cron, fixedDelay, fixedRate 가 있다. 
	    cron 을 많이 쓰고 나머지는 거의 안씀
