...
@MapperScan(basePackages={"com.spring.app.member.model", "com.spring.app.board.model", "com.spring.app.springscheduler.model"}, sqlSessionFactoryRef="sqlSessionFactory") // Mapper Interface 를 사용하기 위한 설정
