...
<head>
    ...
    $(document).ready(function () {
        ...
        $(".ql-editor").html($("textarea[name='recruit_explain']").val());
...
<body>
    ...
    <div class="container m-auto mt-22 lg:grid lg:grid-cols-4 gap-6 xl:max-w-[1140px]">
        ...
        <div class="center lg:col-span-3 mb-4 lg:mb-5 scroll-mt-22 border-rwd">
            ...
            <form name="recruitAddStep2Form" action="${pageContext.request.contextPath}/recruit/edit/${requestScope.recruitVO.recruit_no}/step3" method="post">
            ...
            <%-- 역할 설명 폼 제출용 --%>
            <textarea name="recruit_explain" class="hidden"><c:import url="/resources/files/recruit/${requestScope.recruitVO.recruit_explain_html}" charEncoding="UTF-8"/></textarea>
