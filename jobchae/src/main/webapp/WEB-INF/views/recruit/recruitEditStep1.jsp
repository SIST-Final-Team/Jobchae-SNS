...
<body>
    ...
    <div class="flex items-center justify-center h-200 bg-gray-100">
        ...
        <div class="mx-auto w-md bg-white rounded-lg p-6 shadow-md">
            ...
            <form name="recruitAddStep1Form" action="${pageContext.request.contextPath}/recruit/edit/${requestScope.recruitVO.recruit_no}/step2" method="post">
                <div class="flex flex-col items-center">
                    ...
                    <div class="w-full max-w-md mb-4">
                        ...
                        <input type="text" name="recruit_job_name" id="recruit_job_name"
                            ...
                            value="${requestScope.recruitVO.recruit_job_name}"
                    ...
                    <div class="w-full max-w-md mb-4">
                        ...
                        <select name="recruit_work_type" class="mt-1 p-2 border border-gray-300 rounded-md w-full required"
                            ...
                            <option value="1" ${requestScope.recruitVO.recruit_work_type == "1"?'selected':''}>대면근무</option>
                            <option value="2" ${requestScope.recruitVO.recruit_work_type == "2"?'selected':''}>대면재택혼합근무</option>
                            <option value="3" ${requestScope.recruitVO.recruit_work_type == "3"?'selected':''}>재택근무</option>
                        </select>
                    ...
                    <div class="w-full max-w-md mb-4">
                        ...
                        <select name="recruit_job_type" class="mt-1 p-2 border border-gray-300 rounded-md w-full required"
                            id="recruit_job_type">
                            <option value="1" ${requestScope.recruitVO.recruit_job_type == "1"?'selected':''}>정규직</option>
                            <option value="2" ${requestScope.recruitVO.recruit_job_type == "2"?'selected':''}>시간제</option>
                            <option value="3" ${requestScope.recruitVO.recruit_job_type == "3"?'selected':''}>자영업/개인사업</option>
                            <option value="4" ${requestScope.recruitVO.recruit_job_type == "4"?'selected':''}>프리랜서</option>
                            <option value="5" ${requestScope.recruitVO.recruit_job_type == "5"?'selected':''}>계약직</option>
                            <option value="6" ${requestScope.recruitVO.recruit_job_type == "6"?'selected':''}>인턴</option>
                            <option value="7" ${requestScope.recruitVO.recruit_job_type == "7"?'selected':''}>수습생</option>
                            <option value="8" ${requestScope.recruitVO.recruit_job_type == "8"?'selected':''}>시즌</option>
                        </select>
