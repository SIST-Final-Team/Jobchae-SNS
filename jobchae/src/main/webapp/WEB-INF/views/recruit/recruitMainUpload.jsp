        ...
        <div class="left-side col-span-3 hidden md:block h-full relative">
            <div class="border-normal sticky">
                ...
                <ul class="recruit-nav pb-0!">
                    <li class="recruit-nav-selected"><a href="${pageContext.request.contextPath}/recruit/main/upload">게시된 채용공고</a></li>
                    <li><a href="${pageContext.request.contextPath}/recruit/main/save">나의 채용공고</a></li>
        ...
        <div class="center col-span-10 md:col-span-7 space-y-2">
            <div class="border-rwd pt-4">
                <div class="px-4 space-y-2">
                    <div class="h1">게시된 채용공고</div>
                    <div>
                        <ul class="flex gap-2">
                            <li><button type="button" class="button-selected">진행중</button></li>
                            <li><button type="button" class="button-gray">마감됨</button></li>
                        </ul>
                    </div>
                </div>
                    ...
                    <ul>
                        <li>
                            <button type="button" data-recruit-no="\${item.recruit_no}" class="btn-recruit-info w-full text-left flex">
                                ...
                                <div class="border-b-1 border-gray-300 flex-1 py-2">
                                ...
                                <div class="border-b-1 border-gray-300 flex items-center">
                                    <div class="btn-transparent w-13 h-13 relative"><i class="absolute left-1/2 top-1/2 transform -translate-y-1/2 -translate-x-1/2 fa-solid fa-ellipsis text-xl"></i></div>
                                </div>
                            </button>
                        </li>
                        <li>
