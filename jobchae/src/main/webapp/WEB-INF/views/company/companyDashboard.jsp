        ...
        <div class="scroll-mt-22 border-board">
            ...
            <div class="pt-0! relative pb-4!" id="company-profile">
                ...
                <div class="flex space-x-2 mt-2">
                    <c:if test="${not empty sessionScope.loginuser.member_id && sessionScope.loginuser.member_id != companyVO.member_id && companyVO.isFollow == '0'}">
                        <button type="button" class="follow-button button-orange" data-following-id="${companyVO.company_id}"><i class='fa-solid fa-plus'></i>&nbsp;팔로우</button>
                    </c:if>

                    <c:if test="${not empty sessionScope.loginuser.member_id && sessionScope.loginuser.member_id != companyVO.member_id && companyVO.isFollow == '1'}">
