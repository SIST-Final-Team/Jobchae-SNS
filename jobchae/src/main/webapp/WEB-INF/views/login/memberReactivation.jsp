        ...
        <form name="reactivationFrm">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5 col-md-7" style="position: relative; margin: 0px;">
                    <input type="text" name="member_id" id="member_id" maxlength="16" class="requiredInfo underline disabled" 
                ...
                <div class="w-100"></div>
                <div class="col-lg-5 col-md-7" style="position: relative; margin: 0px;">
                    <input type="email" name="member_email" id="member_email" maxlength="60" class="requiredInfo underline disabled"
                ...
                <input type="hidden" name="member_passwd" id="member_passwd" value="${sessionScope.member_passwd}" />
